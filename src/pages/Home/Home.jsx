  ...
  return (
    <div>
      <div className="home_page-container">
        ...
        >
          <h2 className="modal_form__header-text">Регистрация</h2>
          ...
          {formik.errors.first_name && (
            <span className="error_text">{formik.errors.first_name}</span>
          )}
          ...
          {formik.errors.last_name && (
            <span className="error_text">{formik.errors.last_name}</span>
          )}
          ...
          {formik.errors.telephone_number && (
            <span className="error_text">{formik.errors.telephone_number}</span>
          )}
          <input
            required
            id="sm_link"
            ...
            className="modal_form__input-text"
            onChange={formik.handleChange}
            value={formik.values.sm_link}
            style={{
              border: formik.errors.sm_link ? "2px solid red" : "none",
            }}
          ></input>
          {formik.errors.sm_link && (
            <span className="error_text">{formik.errors.sm_link}</span>
          )}
          <input
            required
            id="password1"
          ...
          {formik.errors.password1 && (
            <span className="error_text">{formik.errors.password1}</span>
          )}
          <input
            required
            id="password2"
          ...
          {formik.errors.password2 && (
            <span className="error_text">{formik.errors.password2}</span>
          )}
          <input
            type="submit"
            value="Зарегистрироваться"
            class="modal_form__submit"
          ></input>
      ...
      <div className="modal_mobile">
        ...
        >
          ...
          <input
            ...
            onChange={formik.handleChange}
            value={formik.values.sm_link}
            style={{ border: formik.errors.sm_link ? "2px solid red" : "none" }}
          ></input>
          {formik.errors.sm_link && (
            <span className="error_text">{formik.errors.sm_link}</span>
          )}
